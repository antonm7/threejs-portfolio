...
export default function Poetry() {
    ...
    return (
        <Layout>
            ...
            <h1 className="responsive_title text-black font-integral font-black text-[55px]">POETRY</h1>
            <p className="responsive_para max-w-3xl text-[#323232] font-display text-3xl pt-6 leading-relaxed">Our plant website is a hub for plant enthusiasts and beginners alike.</p>
